...
describe('P0 AI API client', () => {
  ...
  it('wraps all P0 AI endpoints with expected request paths', async () => {
    ...
    expect(mockGet).toHaveBeenCalledWith('/v2/ai/works/work-1/context-pack/latest', { params: { chapter_id: 'chapter-1' } })
    expect(mockGet).toHaveBeenCalledWith('/v2/ai/works/work-1/context-pack/readiness', { params: { chapter_id: 'chapter-1' } })

...
```text
title 非空：第{order_index}章  {title}
title 为空：第{order_index}章
```
...
```text
┌──────────────────────────────────────────────────────────────┐
│ 第12章  [旧城雨夜____________________________________]         │
└──────────────────────────────────────────────────────────────┘
```
...
- 同一时间只显示一个 Tab。
- Tab 切换前检查当前 Tab 是否存在 dirty。
- 当前 Tab dirty 时，必须提示保存或放弃。
- 用户取消时停留在当前 Tab。
- Tab 切换不影响正文激活章节。

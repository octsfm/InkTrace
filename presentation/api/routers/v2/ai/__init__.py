...
from presentation.api.routers.v2.ai.planning import router as planning_router
...
from presentation.api.routers.v2.ai.suggestions import router as suggestions_router
from presentation.api.routers.v2.ai.settings import router

__all__ = ["continuation_router", "context_pack_router", "initialization_router", "jobs_router", "planning_router", "quick_trial_router", "review_router", "suggestions_router", "router"]
